...
import com.trichain.functionsphp.retrofit.network.RetrofitClient;

//import com.bumptech.glide.Glide;
//import com.bumptech.glide.load.engine.DiskCacheStrategy;
//import com.trichain.kenyasihami.R;
//import com.trichain.kenyasihami.network.ApiService;
//
//import static com.trichain.kenyasihami.util.Constants.BASE_URL;
//import static com.trichain.kenyasihami.util.Constants.imageTypes;
//import static com.trichain.kenyasihami.util.Constants.videoTypes;
...
//        return SharedPrefsManager.getInstance(context).getCurrentUser().getToken();
//    }
   ...
   /* public static boolean isRequiredFileType(String a) {
        for (String type : videoTypes) {
            if (a.toLowerCase().endsWith(type.toLowerCase())) {
                return true;
            }
        }
    ...
    public static boolean isRegistered(Context context) {
        return SharedPrefsManager.getInstance(context).isRegistered();
    }
    ...
    *//*Glide load image into view*//*
    public static void loadImage(ImageView imageView, Drawable drawable) {
        Log.e(TAG, "loadImage: Glide: attempting to load image: using drawable" );
    ...
    *//*Glide load image into view*//*
    public static void loadImage(ImageView imageView, String url, String fallBackUrl) {
        Log.e(TAG, "loadImage: Glide: attempting to load image: " + url);

        try {
            if (url.toLowerCase().contentEquals("http://kenyasihami.co.ke/userProfilepics")){
                Glide.with(imageView)
                        .load(fallBackUrl)
                        .placeholder(R.drawable.ic_user)
                        .diskCacheStrategy(DiskCacheStrategy.ALL)
    ...
    *//*Glide load image into view*//*
    public static void loadImagePost(ImageView imageView, String url) {
        Log.e(TAG, "loadImage: Glide: attempting to load image: " + url);
